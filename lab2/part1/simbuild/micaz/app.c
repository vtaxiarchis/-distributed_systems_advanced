...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b55460231f0, const void *arg_0x2b55460234c8);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 252
extern double erfc(double arg_0x2b55460a59c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x2b55462f3868), 
int (*key_eq_fn)(void *arg_0x2b55462f2020, void *arg_0x2b55462f22c0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b55464e2288, int arg_0x2b55464e24f0);
static double RandomUniform(void );
...
#line 262
static inline void RoutC$sendAnnounce(void );
#line 274
...
#line 353
{
  ...
  if (__nesc_ntoh_uint16(mess->content.nxdata) > 0) {
      RoutC$contentCollect$collected[sim_node()] += __nesc_ntoh_uint16(mess->content.nxdata);
    }
  sim_log_debug(63U, "Sink", "Sink: Have now collected %d pieces of information\n", RoutC$contentCollect$collected[sim_node()]);
}
...
#line 407
      ...
      break;
      default: 
        sim_log_debug(70U, "Error", "ERROR: Unknown message type %d\n", __nesc_ntoh_uint8(mess->type.nxdata));
    }
...
# 67 "/opt/tinyos-2.1.0/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b55469a6450, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x2b55469a6450) {
#line 67
    case 7:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b55469a6450, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 81
# 69 "/opt/tinyos-2.1.0/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b5546e40020, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b5546e40020, addr, msg, len);
#line 69
...
#line 144
  ...
  if (send) {
      ...
      sim_log_debug(47U, "BatteryUse", "BatteryUse: Decreased by %d down to %d\n", use, RoutC$battery[sim_node()]);
    }
  else 
#line 150
    {
      ...
      RoutC$batteryCheck();
      sim_log_debug(48U, "BatteryUse", "BatteryUse: Ran out when trying to send\n");
    }
  return send;
}
...
# 99 "/opt/tinyos-2.1.0/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b55469a7328, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b55469a7328, msg, error);
#line 99
}
#line 99
...
#line 285
{
  ...
  sim_log_debug(189U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 300
    if (mine == CpmModelC$outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(190U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 306
  sim_log_debug(191U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
...
#line 321
      ...
      sim_log_debug_clear(192U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(193U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(194U, "CpmModelC", " no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC$Model$shouldAck(mine->msg)) {
          sim_log_debug_clear(195U, "CpmModelC", " scheduling ack.\n");
...
#line 402
  ...
  while (list != (void *)0) {
      if (!CpmModelC$shouldReceive(list->power - rcv->power)) {
          sim_log_debug(202U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 420
  sim_log_debug(203U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 428
  ...
  sim_log_debug(204U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 279
  ...
  sim_log_debug(181U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 250
{
  ...
  sim_log_debug(179U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(180U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 240
        TossimPacketModelC$sending[sim_node()] = (void *)0;
        sim_log_debug(178U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 192
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(177U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
#line 159
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
      sim_log_error(175U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not initialized!\n");
      return EOFF;
    }
  if (!TossimPacketModelC$running[sim_node()]) {
      sim_log_error(176U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not running!\n");
      return EOFF;
    }
...
#line 116
{
  ...
  sim_log_debug(183U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(184U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
#line 228
  sim_log_debug(188U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1;
    }
  else {
...
#line 299
      ...
      if (msg != TossimPacketModelC$sending[sim_node()]) {
          ...
          sim_log_debug(182U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC$sending[sim_node()]);
        }
    }
}
...
#line 148
  sim_log_debug(185U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1;
    }
  else {
...
# 67 "/opt/tinyos-2.1.0/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b55469a4020, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b55469a4020, msg, payload, len);
#line 67
...
# 89 "/opt/tinyos-2.1.0/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b5546e43e18, message_t * msg, error_t error){
#line 89
  switch (arg_0x2b5546e43e18) {
#line 89
    case 0U:
#line 89
...
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b5546e43e18, msg, error);
#line 89
      break;
#line 89
    }
...
# 64 "/opt/tinyos-2.1.0/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b5546604ab0){
#line 64
  switch (arg_0x2b5546604ab0) {
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b5546604ab0);
#line 64
      break;
#line 64
    }
...
#line 328
{
  ...
  __nesc_hton_uint16(RoutC$message[sim_node()]->content.nxdata, 1);
...
#line 366
{
  ...
  switch (RoutC$PeriodTimer$fired$roundcounter[sim_node()] % 2) {
      ...
      break;
      default: 
        sim_log_debug(66U, "Error", "ERROR: Unknown round %d\n", RoutC$PeriodTimer$fired$roundcounter[sim_node()]);
    }
  RoutC$PeriodTimer$fired$roundcounter[sim_node()]++;
}
...
# 72 "/opt/tinyos-2.1.0/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b5546c1b2f8){
#line 72
  switch (arg_0x2b5546c1b2f8) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b5546c1b2f8);
#line 72
      break;
#line 72
    }
...
#line 84
{
  sim_log_debug(170U, "TossimPacketModelC", "TossimPacketModelC: Init.init() called\n");
...
#line 72
  sim_log_debug(163U, "QueueC", "head <-");
...
#line 77
          sim_log_debug_clear(165U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(166U, "QueueC", "] ");
    }
  sim_log_debug_clear(167U, "QueueC", "<- tail\n");
}
...
#line 201
{
  if (RoutC$RouterQueue$empty()) {
      sim_log_debug(53U, "RoutDetail", "Rout: Rout called with empty queue\n");
    }
  else {
#line 204
    if (RoutC$locked[sim_node()]) {
        sim_log_debug(54U, "RoutDetail", "Rout: Message is locked.\n");
      }
    else {
#line 206
      if (RoutC$batteryEmpty()) {
          sim_log_debug(55U, "RoutDetail", "Rout: Battery is empty.\n");
        }
      else 
#line 208
        {
...
#line 213
          sim_log_debug(56U, "RoutDetail", "Rout: Message will be sent.\n");
          switch (type) {
              case 11: 
              ...
              case 12: 
                if (RoutC$router[sim_node()] == -1) {
                    sim_log_debug(57U, "RoutDetail", "Rout: No router.\n");
                    if (!RoutC$routerlessreported[sim_node()]) {
                        sim_log_debug(58U, "Rout", "Rout: No router to send to\n");
...
#line 226
              ...
              break;
              default: 
                sim_log_debug(59U, "Error", "ERROR: Unknown message type %d\n", type);
            }
          if (send) {
...
{
  if (RoutC$batteryEmpty()) {
      sim_log_debug(46U, "Battery", "Battery: Node ran out of battery\n");
      RoutC$stopnode();
    }
}
...
#line 429
    {
      sim_log_debug(72U, "Error", "ERROR: Got sendDone for another message\n");
    }
}
...
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
      sim_log_error(171U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called before initialization!\n");
      return FAIL;
    }
  sim_log_debug(172U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called.\n");
